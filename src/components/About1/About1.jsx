...
import './About1.css'; // Assume styles are extracted to a CSS file

const About = () => {
  return (
    <div className="about-container">
        <h1>About <span className="highlight">KicksVault</span></h1>
      ...
      <div className="our-story">
        ...
        <div className="story">
            ...
            <p>KicksVault was born from the passion of three lifelong friends and sneaker collectors who wanted to create a premium destination for fellow sneakerheads. What began as a small online store in 2015 has evolved into a respected name in the sneaker community.</p>
      ...
      <section>
        ...
        <p>At KicksVault, our mission is to provide sneaker enthusiasts with authentic, premium footwear while fostering a community that celebrates sneaker culture. We're committed to exceptional service, curated collections, and making every customer feel like part of the KicksVault family.</p>
      </section>
